              ...
              <AnimatedItem index={0}>
                ...
                <div className="mt-6 flex flex-wrap gap-2 sm:gap-3">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-full border px-4 py-2.5 text-sm font-medium transition-all border-white bg-[#0a66c2] text-white hover:border-2"
                  >
